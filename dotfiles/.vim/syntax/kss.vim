" Vim syntax file
" Language:	Krumby Style Sheets
" Maintainer:	Glenn Moss <gim@keynetics.com>
" URL:		https://devsvn.keynetics.com/svn/vim/trunk/syntax/kss.vim
...
syn match kssKeyword "@@[[:alnum:]_-]\+"
syn region kssDirective start="^\s*@@" end=";"
...
syn region cssDefinition transparent matchgroup=cssBraces start='{' end='}' contains=css.*Attr,css.*Prop,cssComment,cssValue.*,cssColor,cssURL,cssImportant,cssError,cssStringQ,cssStringQQ,cssFunction,cssUnicodeEscape,cssTagName,cssClassName,cssIdentifier,cssDefinition,kssDirective,kssKeyword
...
if version >= 508 || !exists("did_css_syn_inits")
  ...
  HiLink kssKeyword Special
  HiLink kssDirective PreProc
  delcommand HiLink
endif
